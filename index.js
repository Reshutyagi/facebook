...
const themeModal = document.querySelector('.coustomize-theme');
...
const closeThemeModal = (e)=>{
    if(e.target.classList.contains('coustomize-theme')){
